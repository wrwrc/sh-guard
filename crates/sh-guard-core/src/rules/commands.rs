...
pub static COMMAND_RULES: &[CommandRule] = &[
    // =====================================================================
    // Common read-only / shell-builtin utilities
    //
    // Unlisted commands default to Intent::Execute (an unknown binary might
    // do anything), which made everyday utilities -- `jq`, `basename`,
    // `sleep`, `cd`, `pgrep`, `otool`, `shasum`, shell builtins like `read`
    // and `break` -- score DANGER inside otherwise read-only scripts.
    // =====================================================================
    CommandRule {
        name: "basename",
        intent: Intent::Info,
    ...
    // Modify files in place (binary rewriting, code signing, temp files).
    CommandRule {
